export const ENVIRONMENT_DATA = {
  title: "Mon combat pour l’environnement",
  descriptions: [
    'Je suis né à Edou, dans le département de la Cuvette, au cœur du Bassin du Congo. J’ai grandi au milieu de la nature congolaise. J’ai ainsi pris conscience, très tôt, de sa beauté, mais surtout, de son importance pour l’humanité. Cette prise de conscience personnelle s’est transformée en engagement politique. En tant que Chef de l’État, mon devoir est de préserver ce patrimoine naturel, un trésor pour le Congo, mais aussi, pour le monde entier qui traverse actuellement une crise climatique sans précédent. C’est pourquoi, la préservation de l’environnement demeure au cœur de mon action au quotidien.'
  ],
  details: [
    {
    ...
    },
    {
      ...
      points: [
        ...
        'La mise sur pied des chaînes de valeur durables dans le secteur forestier, est aussi un axe de réflexion pour que les activités profitent à l’économie, à l’environnement et aux populations locales. Une autre piste de réflexion portera sur les financements innovants de la biodiversité, pour augmenter la quantité et la qualité des financements de la conservation des forêts tropicales.'
      ]
    }
  ]
}